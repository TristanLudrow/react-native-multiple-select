...
export default class MultiSelect extends Component<_t_props> {
  static propTypes = {
  ...
  _itemStyle = (item) => {
    ...
    if (invalid) color = errorColor;

    return { color };
  };

  _getInputTextColor = () => {
    const { textColor, placeholderTextColor, selectedItems, invalid } = this.props;
